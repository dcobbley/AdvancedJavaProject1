        ...
        for (int x = 7; x < args.length; x++) {
            ...
            switch (args[x]) {
                ...
                case "-print":
                    ...
                    break;
                default:
                    throw new Exception("Command Line Argument not found: \"" + args[x] +"\"");
            }
        }
    }
    catch(Exception ex){
